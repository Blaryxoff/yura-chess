...
def snapshot() -> DashboardSnapshot:
    ...
    return DashboardSnapshot("real", "month", datetime(2026, 7, 23, 12, 0, 0), totals, totals, totals, daily)
...
def test_dashboard_is_aggregate_responsive_and_explains_pseudonymous_users() -> None:
    ...
    assert 'href="/?source=test&amp;period=month#statistics"' in html
    assert 'href="/?source=real&amp;period=year#statistics"' in html
