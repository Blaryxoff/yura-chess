...
_HELP = (
    ...
    "Чтобы начать партию, скажите «новая игра белыми» или «новая игра черными уровень десять». "
    "Ход можно назвать, например «пешка е два е четыре» или «конь эф три». "
    "Во время партии можно спросить «что на е четыре», "
    ...
    "«отмени ход», «предлагаю ничью» или «сдаюсь»."
)
