...
from yura_chess.domain.game import EngineSettings, GameMode, GameState, PlayerColor
from yura_chess.domain.results import GameEnd, final_outcome
...
class ReviewService:
    ...
    def _pgn(self, owner_key: str, game: GameState) -> Speech:
        ...
        export = pgn.export(game, final_outcome(game))
