...
COACH_PAGE_HTML = _document(
    ...
    <section class="article">
      ...
      <p>
        Вопрос о позиции посреди честной партии не получает оценку сразу — сначала навык спрашивает
        согласие включить тренера, и только после «да» отвечает по существу. Вот реальная
        последовательность запрос — согласие — фактический ответ:
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          <strong>Навык:</strong> Включаю режим тренера. Например, у вас небольшой перевес.
          Скажите «назови оценку числом», если нужна цифра. Следующий шаг — сделать ход
          или уточнить оценку числом.
        </li>
      </ul>
