...
SECTIONS: tuple[HelpSection, ...] = (
    ...
    HelpSection(
        ...
        (
            ...
            "Если оговорились, поправьтесь сразу: «слон эф один цэ четыре, ой нет пешка е два е четыре».",
            "Чтобы вернуть ходы, скажите: «отмена», «отмени ход» или «отмени три полных хода».",
        ),
    ),
    HelpSection(
        HelpTopic.POSITION,
        ...
        (
            ...
            "Чтобы услышать одну горизонталь, спросите: «кто стоит на седьмой горизонтали».",
            "Если картинку плохо видно, скажите: «плохо вижу доску» — я прочитаю позицию вслух.",
            "Чтобы узнать историю, спросите: «какой был последний ход» или «что делали черные четыре хода назад».",
            "Чтобы вспомнить ход по его номеру, спросите: «какой был второй ход черных».",
        ),
    ),
    HelpSection(
        HelpTopic.FACTS,
    ...
    HelpSection(
        ...
        (
            ...
            "Чтобы узнать текущий уровень, спросите: «какой уровень».",
            "Чтобы изменить уровень прямо в партии, скажите: «уровень пять». Позиция сохранится.",
            "Чтобы сменить цвет, скажите: «давай белыми» или «я играю черными».",
    ...
    HelpSection(
        ...
        "настройки",
        (
            "Подробность меняют команды: «говори кратко», «говори обычно» и «говори подробно».",
            (
            ...
            "Игровые сигналы переключают команды: «включи звуки» и «выключи звуки».",
        ),
    ),
    HelpSection(
        HelpTopic.TRAINING,
    ...
    HelpSection(
        ...
        (
            ...
            (
                "О ключевых моментах спросите: «где перелом», «главная ошибка», «сколько раз я ошибся», "
                "«сколько ошибок я сделал» или «сколько у меня ошибок»."
            ),
    ...
    HelpSection(
        ...
        (
            (
                "Команда «дай задачу» открывает задачу. Темы: «задача на мат в один ход», мат в два хода, "
                "вилка, связка и сквозной удар. "
