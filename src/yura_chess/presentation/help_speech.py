...
SECTIONS: tuple[HelpSection, ...] = (
    ...
    HelpSection(
        ...
        (
            ...
            "«Предлагаю ничью» проверяет, можно ли сейчас потребовать ничью; "
            "«сдаюсь» завершается только после подтверждения.",
    ...
    HelpSection(
        ...
        "настройки",
        (
            "«Говори кратко», «обычная подробность ответов» и «говори подробно» меняют подробность ответов.",
            ...
            "«Доска всегда за белых», «доска всегда за черных» или «доска по моему цвету» задает ориентацию на экране.",
        ),
    ),
    HelpSection(
        HelpTopic.TRAINING,
    ...
    HelpSection(
        ...
        "задачи",
        (
            "«Дай задачу» открывает задачу. Темы: мат в один, мат в два, вилка, связка, сквозной удар, "
            "мат по последней горизонтали, вскрытое нападение и висячая фигура.",
            "«Повтори задачу» еще раз читает позицию. «Следующая задача» берет новую, "
    ...
    HelpSection(
        ...
        (
            ...
            "«Повтори ответ», «повтори последнюю фразу» или «повтори медленно» еще раз читает мой прошлый ответ.",
