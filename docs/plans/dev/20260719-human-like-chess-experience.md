...
- [x] Показывать на главной странице перед разделом конфиденциальности агрегаты реальных пользователей по умолчанию, отдельные вкладки test/all и динамику за месяц/год/всё время без раскрытия идентификаторов
